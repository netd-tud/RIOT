...
/* The size of the PKA SRAM module, in Bytes.
 * Known values are: 0x100 (4KiB) for cc310, 0x1800 (6KiB) for cc312
 */
#ifndef CC3XX_CONFIG_PKA_SRAM_SIZE
#define CC3XX_CONFIG_PKA_SRAM_SIZE 0x1800
#endif /* !CC3XX_CONFIG_PKA_SRAM_SIZE */

 ...
 *
 * @file        psa_hmac.c
 * @brief       Generic PSA Crypto HMAC implementation.
 *
...
static psa_status_t psa_hmac_setup_key(psa_mac_operation_t *operation,
...
psa_status_t psa_hmac_compute(psa_key_id_t key,
                              psa_algorithm_t alg,
                              const uint8_t *input,
                              size_t input_length,
                              uint8_t *mac,
...
psa_status_t psa_hmac_verify(psa_key_id_t key,
                             psa_algorithm_t alg,
                             const uint8_t *input,
                             size_t input_length,
                             const uint8_t *mac,
...
psa_status_t psa_hmac_setup(psa_mac_operation_t *operation,
                            const uint8_t *key_buffer,
                            size_t key_buffer_size,
                            psa_algorithm_t alg)
{
...
psa_status_t psa_hmac_update(psa_mac_operation_t *operation,
                             const uint8_t *input,
                             size_t input_length)
{
...
psa_status_t psa_hmac_sign_finish(psa_mac_operation_t *operation,
                                  uint8_t *mac,
                                  size_t mac_size,
                                  size_t *mac_length)
{
...
psa_status_t psa_hmac_verify_finish(psa_mac_operation_t *operation,
                                    const uint8_t *mac,
                                    size_t mac_length)
{
...
psa_status_t psa_hmac_abort(psa_mac_operation_t *operation)
{
    psa_algorithm_t hash_alg = PSA_ALG_GET_HASH(operation->alg);
    size_t block_length = PSA_HASH_BLOCK_LENGTH(hash_alg);
    psa_status_t status;
